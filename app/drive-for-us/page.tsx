...
export default function DriveForUs() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: "Drive for Us", url: "https://www.knclogistics.com/drive-for-us" },
  ]);

  return (
    <>
      <Script
        id="drive-for-us-breadcrumb-schema"
      ...
      <main>
        ...
        {/* Hero Section */}
        <section className="contact" id="drive-for-us">
