...
export default function DieselMechanic() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: "Careers", url: "https://www.knclogistics.com/apply" },
    {
      ...
      url: "https://www.knclogistics.com/apply/diesel-mechanic",
    },
  ]);
  ...
  return (
    <>
      <Script
        id="diesel-mechanic-breadcrumb-schema"
      ...
      <main>
        ...
        <section className="breadcrumb">
          <div className="breadcrumb-container">
            ...
            <span className="breadcrumb-separator">/</span>
            <span>Diesel Mechanic</span>
          </div>
        </section>

        <section className="contact" id="diesel-mechanic">
          {/* Job Header */}
            ...
            <div className="contact-info scroll-animate-left">
              <div className="contact-item">
                ...
                <div>
                  ...
                  <p>
                    We are seeking a skilled Diesel Mechanic to join our team.
                    The ideal candidate will be responsible for inspecting,
                    maintaining, and repairing trucks to ensure safe and
                    efficient operation.
                  </p>
                </div>
              </div>
              ...
              <div className="contact-item">
                ...
                <div>
                  ...
                  <ul style={{ paddingLeft: "1.2rem", lineHeight: "1.9" }}>
                    <li>Perform routine maintenance on trucks and trailers</li>
                    <li>Diagnose mechanical and electrical issues</li>
                    <li>Repair engines, brakes, transmissions, and other components</li>
                    <li>Conduct safety inspections and preventive maintenance</li>
                    <li>Keep maintenance records and reports</li>
              ...
              <div className="contact-item">
                ...
                <div>
                  <h2>Requirements</h2>
                  <ul style={{ paddingLeft: "1.2rem", lineHeight: "1.9" }}>
                    <li>Minimum 2–3 years of experience as a diesel mechanic</li>
                    <li>Strong knowledge of truck systems and diagnostics</li>
                    <li>Ability to use diagnostic tools and equipment</li>
                    <li>Reliable and detail-oriented</li>
                    <li>Ability to work independently</li>
                    <li>Basic English required</li>
                  </ul>
                </div>
              </div>
            </div>
