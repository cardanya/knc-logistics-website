...
export default function SupplyChainSpecialist() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const data = await submitContactForm({
        data: {
          service: "Supply Chain and Systems Optimization Specialist",
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: "Careers", url: "https://www.knclogistics.com/apply" },
    {
      ...
      url: "https://www.knclogistics.com/apply/supply-chain-specialist",
    },
  ]);
  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="contact" id="supply-chain-specialist">
          {/* Job Header */}
          <div className="section-header scroll-animate">
            <h1>Supply Chain and Systems Optimization Specialist</h1>
            <p>
            ...
            <div className="contact-info scroll-animate-left">
              <div className="contact-item">
                ...
                <div>
                  ...
                  <p>
                    Plan, analyze, and digitize logistics supply chain
                    operations to enhance performance, accuracy, and
                    profitability. Integrate systems engineering principles and
                    AI-driven digitalization to support modernization and
                    international expansion — focusing on developing and
                    strengthening business relationships with Turkish clients and
                    partners.
                  </p>
                </div>
              </div>
                ...
                <div>
                  ...
                  <ul style={{ paddingLeft: "1.2rem", lineHeight: "1.9" }}>
                    <li>
                      ...
                      Engineering, Supply Chain Management, or related field (or
                      foreign equivalent)
                    </li>
                    <li>
                      Minimum 1 year of experience using both SAP and Oracle
                    </li>
                    <li>
                      Proficiency in data analytics tools: Excel (Advanced),
                      Python (Advanced), Tableau, Power BI
                    </li>
                    <li>
                      Experience with AI-driven workflow automation (e.g., n8n,
                      API integrations, Generative AI and Agentic AI tools)
                      applied to operations and process optimization
                    </li>
                    <li>
                      Demonstrated experience in logistics planning &amp;
                      coordination, operations optimization, cost–benefit
                      analysis, system optimization, digital workflow
                      improvements, and ERP-based operational process design
                    </li>
                    <li>Fluency in Turkish</li>
                    <li>Ability to travel to Turkey</li>
                  </ul>
                </div>
              </div>
            </div>
