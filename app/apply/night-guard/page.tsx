...
export default function NightGuard() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    {
      name: "Night Guard",
      url: "https://www.knclogistics.com/apply/night-guard",
    },
  ]);
  ...
  return (
    <>
      <Script
        id="night-guard-breadcrumb-schema"
      ...
      <main>
        ...
        <section className="contact" id="night-guard">
          {/* Job Header */}
            ...
            <div className="contact-info scroll-animate-left">
              <div className="contact-item">
                ...
                <div>
                  ...
                  <p>
                    We are looking for a responsible Night Guard to ensure the
                    safety and security of our yard and equipment during
                    overnight hours.
                  </p>
                </div>
              </div>
              ...
              <div className="contact-item">
                ...
                <div>
                  ...
                  <ul style={{ paddingLeft: "1.2rem", lineHeight: "1.9" }}>
                    <li>Monitor yard and premises during night shifts</li>
                    <li>Prevent unauthorized access and report suspicious activity</li>
                    <li>Conduct routine patrols of the property</li>
                    <li>Keep a log of nightly activities and incidents</li>
                    <li>Ensure gates and trucks are secure</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="contact-item">
                ...
                <div>
                  <h2>Requirements</h2>
                  <ul style={{ paddingLeft: "1.2rem", lineHeight: "1.9" }}>
                    <li>Previous security experience preferred</li>
                    <li>Reliable and alert</li>
