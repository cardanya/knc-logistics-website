...
export const metadata = generateServiceMetadata(serviceMetadata.parkingSolutions);

export default function ParkingSolutions() {
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: "Home", url: "https://www.knclogistics.com/" },
    { name: "Parking Solutions", url: "https://www.knclogistics.com/parking-solutions" }
  ]);
  ...
  const serviceSchema = generateServiceSchema({
    ...
    url: "https://www.knclogistics.com/parking-solutions"
  });
